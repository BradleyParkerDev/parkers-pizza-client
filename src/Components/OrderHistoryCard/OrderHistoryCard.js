...
const OrderHistoryCard = () =>{
    return(
        <div id = 'OHC-Container' className="flex justify-evenly w-[340px] h-[61px] md:w-[659px] md:h-[62px] border-solid border-[1px] border-black rounded-[5px] mb-[9px] ">
            <div id = 'order-number' className="border-dashed border-[1px] border-[red] h-[100%] w-[33%]">

            </div>
            <div id = 'order-date' className="border-dashed border-[1px] border-[red] h-[100%] w-[33%]">
